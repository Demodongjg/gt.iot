...
@MapperScan(basePackages = {"gt.iot.wlw.flink.dao"},sqlSessionTemplateRef  = "tdengineSqlSessionTemplate")
@Configuration
public class TDengineServerConfig {
    ...
    public SqlSessionFactory tdengineSqlSessionFactory(@Qualifier("tdengineDataSource") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:gt/iot/wlw/flink/dao/*.xml"));
